...
<Figure caption="Inherited design direction.">
  <Image src={heroImg} alt="Original Adobe Express homepage design" />
</Figure>
...
<Figure caption="Initial homepage test.">
  <Image src={heroImg} alt="First homepage test design" />
</Figure>
...
<Figure caption="Future state. Credit to Mairi Watson, Julia Haney, Magdalena Long, Sal Ghaffarsamar.">
  <Image src={heroImg} alt="Future state homepage design" />
</Figure>
